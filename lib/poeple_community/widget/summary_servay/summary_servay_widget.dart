...
import 'summary_servay_model.dart';
export 'summary_servay_model.dart';

class SummaryServayWidget extends StatefulWidget {
  const SummaryServayWidget({super.key});

  @override
  State<SummaryServayWidget> createState() => _SummaryServayWidgetState();
}

class _SummaryServayWidgetState extends State<SummaryServayWidget> {
  late SummaryServayModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SummaryServayModel());
                                ...
                                Row(
                                  ...
                                  children: [
                                    Expanded(
                                      flex: 2,
                                      child: Text(
                                        '1.แพทย์บอกมีไขมันในเลือดผิดปกติ',
                                        style: FlutterFlowTheme.of(context)
                                            .labelSmall
                                            .override(
                                              fontFamily:
                                ...
                                Row(
                                  ...
                                  children: [
                                    Expanded(
                                      flex: 2,
                                      child: Text(
                                        '2.มีประวัติหรือเคยมีประวัติน้ำตาลในเลือดสูง',
                                        style: FlutterFlowTheme.of(context)
                                            .labelSmall
                                            .override(
                                              fontFamily:
