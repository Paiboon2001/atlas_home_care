...
export 'information_community_one_model.dart';

class InformationCommunityOneWidget extends StatefulWidget {
  const InformationCommunityOneWidget({super.key});

  static String routeName = 'information_community_one';
  static String routePath = '/informationCommunityOne';

  @override
  State<InformationCommunityOneWidget> createState() =>
      _InformationCommunityOneWidgetState();
}

class _InformationCommunityOneWidgetState
    extends State<InformationCommunityOneWidget> {
  late InformationCommunityOneModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InformationCommunityOneModel());
                                      ...
                                      () => InkWell(
                                            ...
                                            child: wrapWithModel(
                                              ...
                                              child: const AssignmentsWidget(
                                                ...
                                                text:
                                                    'แบบประเมิน Barthel Index Score',
                                              ),
                                            ),
                                          ),
                                      () => InkWell(
                                            ...
                                            onTap: () async {
                                              context.pushNamed(
                                                ADLEverydayWidget.routeName,
                                                queryParameters: {
                                                  'pagebarthel': serializeParam(
                                                    false,
                                                    ParamType.bool,
                                                  ),
                                                }.withoutNulls,
                                      ...
                                      () => InkWell(
                                            ...
                                            child: wrapWithModel(
                                              ...
                                              child: const AssignmentsWidget(
                                                ...
                                                text:
                                                    'แบบประเมินผู้ป่วยเบาหวานความดัน',
                                              ),
                                            ),
                                          ),
                                      () => InkWell(
                                            ...
                                            child: wrapWithModel(
                                              ...
                                              child: const AssignmentsWidget(
                                                ...
                                                text:
                                                    'แบบประเมินผู้ป่วย Palliative Care',
                                              ),
                                            ),
                                          ),
                                      () => InkWell(
                                      ...
                                      () => InkWell(
                                            ...
                                            child: wrapWithModel(
                                              ...
                                              child: const AssignmentsWidget(
                                                ...
                                                text:
                                                    'แบบประเมินภาระการดูแลผู้ป่วยที่บ้าน ',
                                              ),
                                            ),
                                          ),
                                      () => InkWell(
