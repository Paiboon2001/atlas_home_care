...
import 'room_check_model.dart';
export 'room_check_model.dart';

class RoomCheckWidget extends StatefulWidget {
  const RoomCheckWidget({super.key});

  @override
  State<RoomCheckWidget> createState() => _RoomCheckWidgetState();
}

class _RoomCheckWidgetState extends State<RoomCheckWidget> {
  late RoomCheckModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RoomCheckModel());
