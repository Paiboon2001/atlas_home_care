...
import 'rpt_model.dart';
export 'rpt_model.dart';

class RptWidget extends StatefulWidget {
  const RptWidget({super.key});

  @override
  State<RptWidget> createState() => _RptWidgetState();
}

class _RptWidgetState extends State<RptWidget> {
  late RptModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RptModel());
