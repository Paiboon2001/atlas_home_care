...
import 'two_q_model.dart';
export 'two_q_model.dart';

class TwoQWidget extends StatefulWidget {
  const TwoQWidget({super.key});

  static String routeName = 'Two_Q';
  static String routePath = '/twoQ';

  @override
  State<TwoQWidget> createState() => _TwoQWidgetState();
}

class _TwoQWidgetState extends State<TwoQWidget> with TickerProviderStateMixin {
  late TwoQModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TwoQModel());
    ...
    animationsMap.addAll({
      ...
      'tqoneOnActionTriggerAnimation1': AnimationInfo(
      ...
      'tqoneOnActionTriggerAnimation2': AnimationInfo(
        trigger: AnimationTrigger.onActionTrigger,
        applyInitialState: true,
        effectsBuilder: () => [
          ScaleEffect(
      ...
      'tqtwoOnActionTriggerAnimation1': AnimationInfo(
        trigger: AnimationTrigger.onActionTrigger,
        applyInitialState: true,
        effectsBuilder: () => [
          ScaleEffect(
      ...
      'tqtwoOnActionTriggerAnimation2': AnimationInfo(
        trigger: AnimationTrigger.onActionTrigger,
        applyInitialState: true,
        effectsBuilder: () => [
          ScaleEffect(
                                  ...
                                  itemBuilder: (context, index) {
                                    return [
                                      () => InkWell(
                                            ...
                                            onTap: () async {
                                              if (animationsMap[
                                                      'tqoneOnActionTriggerAnimation1'] !=
                                                  null) {
                                                animationsMap[
                                                        'tqoneOnActionTriggerAnimation1']!
                                                    .controller
                                      ...
                                      () => InkWell(
                                            ...
                                            onTap: () async {
                                              if (animationsMap[
                                                      'tqoneOnActionTriggerAnimation2'] !=
                                                  null) {
                                                animationsMap[
                                                        'tqoneOnActionTriggerAnimation2']!
                                                    .controller
                                  ...
                                  itemBuilder: (context, index) {
                                    return [
                                      () => InkWell(
                                            ...
                                            onTap: () async {
                                              if (animationsMap[
                                                      'tqtwoOnActionTriggerAnimation1'] !=
                                                  null) {
                                                animationsMap[
                                                        'tqtwoOnActionTriggerAnimation1']!
                                                    .controller
                                      ...
                                      () => InkWell(
                                            ...
                                            onTap: () async {
                                              if (animationsMap[
                                                      'tqtwoOnActionTriggerAnimation2'] !=
                                                  null) {
                                                animationsMap[
                                                        'tqtwoOnActionTriggerAnimation2']!
                                                    .controller
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'เกณฑ์การวัดผลแบบคัดกรองโรคซึมเศร้า (2Q)',
                                          style: FlutterFlowTheme.of(context)
                                              .labelSmall
                                              .override(
                                                fontFamily:
