...
import 'l_a_b_bloodfat_model.dart';
export 'l_a_b_bloodfat_model.dart';

class LABBloodfatWidget extends StatefulWidget {
  const LABBloodfatWidget({super.key});

  static String routeName = 'LAB_Bloodfat';
  static String routePath = '/lABBloodfat';

  @override
  State<LABBloodfatWidget> createState() => _LABBloodfatWidgetState();
}

class _LABBloodfatWidgetState extends State<LABBloodfatWidget> {
  late LABBloodfatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LABBloodfatModel());
