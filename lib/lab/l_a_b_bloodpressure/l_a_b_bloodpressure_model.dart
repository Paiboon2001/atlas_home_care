...
import 'dart:ui';
import '/index.dart';
import 'l_a_b_bloodpressure_widget.dart' show LABBloodpressureWidget;
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';

class LABBloodpressureModel extends FlutterFlowModel<LABBloodpressureWidget> {
  ...
  // Model for item_diabetes component.
  late ItemDiabetesModel itemDiabetesModel6;
  // Model for item_diabetes component.
  late ItemDiabetesModel itemDiabetesModel7;
  // Model for item_diabetes component.
  late ItemDiabetesModel itemDiabetesModel8;
  // Model for item_diabetes component.
  late ItemDiabetesModel itemDiabetesModel9;
  ...
  void initState(BuildContext context) {
    ...
    itemDiabetesModel6 = createModel(context, () => ItemDiabetesModel());
    itemDiabetesModel7 = createModel(context, () => ItemDiabetesModel());
    itemDiabetesModel8 = createModel(context, () => ItemDiabetesModel());
    itemDiabetesModel9 = createModel(context, () => ItemDiabetesModel());
  }
  ...
  void dispose() {
    ...
    itemDiabetesModel6.dispose();
    itemDiabetesModel7.dispose();
    itemDiabetesModel8.dispose();
    itemDiabetesModel9.dispose();
  }
}
