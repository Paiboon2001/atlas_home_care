...
class MedicaldeliveryWidget extends StatefulWidget {
  const MedicaldeliveryWidget({
    super.key,
    required this.photo,
    required this.text,
    required this.chand,
  ...
  static String routeName = 'medicaldelivery';
  static String routePath = '/medicaldelivery';

  @override
  State<MedicaldeliveryWidget> createState() => _MedicaldeliveryWidgetState();
}

class _MedicaldeliveryWidgetState extends State<MedicaldeliveryWidget>
    with TickerProviderStateMixin {
  late MedicaldeliveryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MedicaldeliveryModel());
