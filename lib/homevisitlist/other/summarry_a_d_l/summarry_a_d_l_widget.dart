...
class SummarryADLWidget extends StatefulWidget {
  const SummarryADLWidget({super.key});

  @override
  State<SummarryADLWidget> createState() => _SummarryADLWidgetState();
}

class _SummarryADLWidgetState extends State<SummarryADLWidget>
    with TickerProviderStateMixin {
  late SummarryADLModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SummarryADLModel());
