...
import 'search_task_model.dart';
export 'search_task_model.dart';
...
class _SearchTaskWidgetState extends State<SearchTaskWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SearchTaskModel());
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      Expanded(
                        child: wrapWithModel(
                          model: _model.itemPPTemplateModel1,
                          updateCallback: () => safeSetState(() {}),
                          child: const ItemPPTemplateWidget(
                            pptemplate: 'Template1',
                          ),
                        ),
                      ),
                      Expanded(
                        child: wrapWithModel(
                          model: _model.itemPPTemplateModel2,
                          updateCallback: () => safeSetState(() {}),
                          child: const ItemPPTemplateWidget(
                            pptemplate: 'Template2',
                          ),
                        ),
                      ),
                    ]
