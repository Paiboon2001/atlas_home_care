...
import 'home_care_model.dart';
export 'home_care_model.dart';

class HomeCareWidget extends StatefulWidget {
  const HomeCareWidget({
    super.key,
    required this.homename,
    required this.numhome,
    required this.manyhome,
    required this.manypoeple,
  });

  final String? homename;
  final String? numhome;
  final String? manyhome;
  final String? manypoeple;

  @override
  State<HomeCareWidget> createState() => _HomeCareWidgetState();
}

class _HomeCareWidgetState extends State<HomeCareWidget> {
  late HomeCareModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeCareModel());
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () async {
        context.pushNamed(HomevisitlistWidget.routeName);
      },
      child: Container(
