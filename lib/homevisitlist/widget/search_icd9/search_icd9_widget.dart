...
import 'search_icd9_model.dart';
export 'search_icd9_model.dart';

class SearchIcd9Widget extends StatefulWidget {
  const SearchIcd9Widget({super.key});

  @override
  State<SearchIcd9Widget> createState() => _SearchIcd9WidgetState();
}

class _SearchIcd9WidgetState extends State<SearchIcd9Widget> {
  late SearchIcd9Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SearchIcd9Model());
