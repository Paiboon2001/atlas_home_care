...
import 'blood_summary_model.dart';
export 'blood_summary_model.dart';

class BloodSummaryWidget extends StatefulWidget {
  const BloodSummaryWidget({super.key});

  static String routeName = 'Blood_summary';
  static String routePath = '/bloodSummary';

  @override
  State<BloodSummaryWidget> createState() => _BloodSummaryWidgetState();
}

class _BloodSummaryWidgetState extends State<BloodSummaryWidget> {
  late BloodSummaryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BloodSummaryModel());
        ...
        children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                context
                                    .pushNamed(SummaryPressureWidget.routeName);
                              },
                              child: Container(
                                width: double.infinity,
                                decoration: BoxDecoration(
                                      ...
                                      Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              'ผู้ประเมิน : นางวิเศษ เจริญพิพัฒน์',
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .bodyMedium
                                                  .override(
          ...
          Align(
            ...
            child: InkWell(
              ...
              highlightColor: Colors.transparent,
              onTap: () async {
                context.pushNamed(MainBloodWidget.routeName);
              },
              child: wrapWithModel(
