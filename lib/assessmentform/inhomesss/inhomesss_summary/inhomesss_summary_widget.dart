...
import 'inhomesss_summary_model.dart';
export 'inhomesss_summary_model.dart';

class InhomesssSummaryWidget extends StatefulWidget {
  const InhomesssSummaryWidget({super.key});

  static String routeName = 'Inhomesss_Summary';
  static String routePath = '/inhomesssSummary';

  @override
  State<InhomesssSummaryWidget> createState() => _InhomesssSummaryWidgetState();
}

class _InhomesssSummaryWidgetState extends State<InhomesssSummaryWidget> {
  late InhomesssSummaryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InhomesssSummaryModel());
        ...
        children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                context
                                    .pushNamed(InhomessResultWidget.routeName);
                              },
                              child: Container(
                                width: double.infinity,
                                decoration: BoxDecoration(
          ...
          Align(
            ...
            child: InkWell(
              ...
              highlightColor: Colors.transparent,
              onTap: () async {
                context.pushNamed(FormINHOMESSSWidget.routeName);
              },
              child: wrapWithModel(
