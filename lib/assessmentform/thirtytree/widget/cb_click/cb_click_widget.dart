...
import 'cb_click_model.dart';
export 'cb_click_model.dart';

class CbClickWidget extends StatefulWidget {
  const CbClickWidget({
    super.key,
    required this.text,
  });
  ...
  @override
  State<CbClickWidget> createState() => _CbClickWidgetState();
}

class _CbClickWidgetState extends State<CbClickWidget>
    with TickerProviderStateMixin {
  late CbClickModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CbClickModel());
