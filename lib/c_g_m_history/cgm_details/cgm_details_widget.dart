...
import 'cgm_details_model.dart';
export 'cgm_details_model.dart';

class CgmDetailsWidget extends StatefulWidget {
  const CgmDetailsWidget({
    super.key,
    required this.photo,
    required this.text,
    required this.chand,
  ...
  static String routeName = 'cgm_details';
  static String routePath = '/cgmDetails';

  @override
  State<CgmDetailsWidget> createState() => _CgmDetailsWidgetState();
}

class _CgmDetailsWidgetState extends State<CgmDetailsWidget>
    with TickerProviderStateMixin {
  late CgmDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CgmDetailsModel());
